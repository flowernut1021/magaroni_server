...
<html>
    ...
    <body>
        ...
        <div id="show-technician" class="content scaffold-show" role="main">
            ...
            <f:display bean="technician" />
            <g:form resource="${this.technician}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.technician}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
