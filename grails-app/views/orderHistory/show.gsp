...
<html>
    ...
    <body>
        ...
        <div id="show-orderHistory" class="content scaffold-show" role="main">
            ...
            <f:display bean="orderHistory" />
            <g:form resource="${this.orderHistory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orderHistory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
